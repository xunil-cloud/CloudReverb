...
juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    auto TapSeed = MAKE_PARAMETER_INT(TapSeed, 0, 1000000, 1, );

    auto DiffusionSeed = MAKE_PARAMETER_INT(DiffusionSeed, 0, 1000000, 1, );

    auto DelaySeed = MAKE_PARAMETER_INT(DelaySeed, 0, 1000000, 1, );

    auto PostDiffusionSeed = MAKE_PARAMETER_INT(PostDiffusionSeed, 0, 1000000, 1, );
